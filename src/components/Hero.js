  ...
  return (
    <section id="hero">
      ...
      <div className="hbody">
        ...
        <p className="hsub">
          <span className="an-wrd">Looking</span> <span className="an-wrd">for</span> <span className="an-wrd">the</span> <span className="an-wrd">perfect</span> <span className="an-wrd">DTCP</span> <span className="an-wrd">plots</span> <span className="an-wrd">for</span> <span className="an-wrd">sale</span> <span className="an-wrd">in</span> <span className="an-wrd">Trichy?</span> <span className="an-wrd">I</span> <span className="an-wrd">personally</span> <span className="an-wrd">guide</span> <span className="an-wrd">you</span> <span className="an-wrd">from</span> <span className="an-wrd">site</span> <span className="an-wrd">visit</span> <span className="an-wrd">to</span> <span className="an-wrd">registration</span> <span className="an-wrd">—</span> <span className="an-wrd">no</span> <span className="an-wrd">agents,</span> <span className="an-wrd">no</span> <span className="an-wrd">middlemen,</span> <span className="an-wrd">just</span> <span className="an-wrd">me.</span>
        </p>
        <div className="hbtns">
          <a href="#locations" className="bg">View My Listings</a>
